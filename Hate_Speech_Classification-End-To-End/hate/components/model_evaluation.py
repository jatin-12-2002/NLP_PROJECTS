 ...
 data transformation artifact stage
    ...
    def get_best_model_from_aws(self) -> str:
        ...
        try:
            ...
            self.awscloud.download_object(self.model_evaluation_config.MODEL_NAME,
    ...
    def evaluate(self):
        ...
        :param model: Currently trained model or best model from AWS S3 storage
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifacts:
        ...
        try:
            ...
            logging.info("Fetch best model from AWS S3 storage")
            best_model_path = self.get_best_model_from_aws()

            logging.info("Check is best model present in the AWS S3 storage or not ?")
            if os.path.isfile(best_model_path) is False:
                is_model_accepted = True
                logging.info("AWS S3 storage model is false and currently trained model accepted is true")

            else:
                logging.info("Load best model fetched from AWS S3 storage")
